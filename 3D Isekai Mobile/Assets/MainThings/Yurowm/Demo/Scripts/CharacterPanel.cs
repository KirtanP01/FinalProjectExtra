...
public class CharacterPanel : MonoBehaviour {
	...
	Actions actions;
	PlayerControllerSporty controller;
	Camera[] cameras;
	...
	void Initialize () {
		...
		controller = character.GetComponent<PlayerControllerSporty> ();

		foreach (PlayerControllerSporty.Arsenal a in controller.arsenal)
